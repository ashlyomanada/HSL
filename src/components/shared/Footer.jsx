...
const Footer = () => {
  return (
    <footer className="lg:min-h-[50vh] bg-[#23284c] flex items-center py-10 px-5 md:px-10 xl:px-20 text-white">
      <div className="flex flex-col-reverse gap-10 lg:gap-0 lg:flex-row">
        ...
        <div className="flex lg:w-[30%] flex-col gap-3">
          ...
          <div className="flex items-center justify-start w-full">
            <input
              ...
              className="bg-white text-black px-3 py-2 ring-0"
            />
